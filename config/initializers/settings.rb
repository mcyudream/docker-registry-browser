...
Rails.application.config.tap do |config|
  ...
  config.x.registry_type       = Config.get(name: "REGISTRY_TYPE", default: "registry", allow: %w[auto registry harbor])
  ...
  config.x.sort_tags_by        = Config.get(name: "SORT_TAGS_BY", default: "name", allow: %w[api name version time])
